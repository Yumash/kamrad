...
### Есть ли карты России и СНГ?

Да! КАМРАД позволяет извлечь карту **любого региона мира**, включая Россию (9 федеральных округов + Москва + СПб), все страны СНГ, Европу, Азию, Африку, Америку — всего 52 региона. Карты извлекаются из планетарного файла ProtoMaps через HTTP — скачивается только нужный регион, а не 120 ГБ целиком. Подробнее: [docs/maps-guide.md](admin/docs/maps-guide.md).
